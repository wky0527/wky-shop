...
.adm-popover-inner {
  ...
  border-radius: 8px;
  box-shadow: 0 6px 12px -8px rgba(0, 0, 0, 0.12), 0 12px 32px 0 rgba(0, 0, 0, 0.08), 0 18px 56px 16px rgba(0, 0, 0, 0.05);
  box-shadow: 0 0 16px rgba(0, 0, 0, 0.15) \9;
  min-width: 64px;
  min-height: 64px;
  overflow-y: hidden;
}
...
.adm-popover-placement-topRight > .adm-popover-content > .adm-popover-arrow {
  ...
  box-shadow: 6px 6px 14px rgba(0, 0, 0, 0.07);
}
