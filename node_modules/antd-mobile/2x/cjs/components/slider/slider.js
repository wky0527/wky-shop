...
var Slider = (0, _withDefaultProps.withDefaultProps)(defaultProps)(function (props) {
  var _classNames;
  ...
  var _useNewControllableVa = (0, _useControllableValue.useNewControllableValue)({
    ...
    onChange: props.onChange
      ...
      rawValue = _useNewControllableVa[0],
      setRawValue = _useNewControllableVa[1];
  ...
  var onTrackClick = function onTrackClick(event) {
    ...
    if (disabled) return;
    var sliderOffsetLeft = trackRef.current.getBoundingClientRect().left;
    var position = (event.clientX - sliderOffsetLeft) / Math.ceil(trackRef.current.offsetWidth) * (max - min) + min;
