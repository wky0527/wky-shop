...
var Swiper = /*#__PURE__*/(0, _react.forwardRef)((0, _stagedComponents.staged)(function (p, ref) {
  ...
  return function () {
    ...
    if (count === 1 && loop) {
      (0, _devLog.devWarning)('Swiper', '`Swiper` needs at least two children to enable loop.');
      loop = false;
    }
    ...
    var _useSpring = (0, _web.useSpring)(function () {
      return {
        x: (0, _bound.bound)(current, 0, count - 1) * 100,
        config: {
          tension: 200,
          friction: 30
        },
    ...
    var bind = (0, _react2.useDrag)(function (state) {
      ...
      if (!state.last) {
        ...
        var index = Math.round((offsetX + state.velocity[0] * state.direction[0] * 200) / width);
        swipeTo(index);
    ...
    }, props.allowTouchMove ? bind() : {}), /*#__PURE__*/_react["default"].createElement("div", {
    ...
    }))), props.indicator === undefined ? /*#__PURE__*/_react["default"].createElement("div", {
