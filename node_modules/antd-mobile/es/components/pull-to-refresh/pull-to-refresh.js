...
(function (PullStatus) {
  PullStatus[PullStatus["idle"] = 0] = "idle";
  PullStatus[PullStatus["thresholdMet"] = 1] = "thresholdMet";
  PullStatus[PullStatus["refreshing"] = 2] = "refreshing";
  PullStatus[PullStatus["complete"] = 3] = "complete";
...
export var PullToRefresh = withDefaultProps(defaultProps)(function (props) {
  ...
  var _useState = useState(PullStatus.idle),
      status = _useState[0],
  ...
  useDrag(function (state) {
    if (status === PullStatus.refreshing || status === PullStatus.complete) return;
    ...
    setStatus(height > threshold ? PullStatus.thresholdMet : PullStatus.idle);
  }, {
    pointer: {
      touch: true
    },
  ...
  }, status === PullStatus.idle && props.pullingText, status === PullStatus.thresholdMet && props.releaseText, status === PullStatus.refreshing && props.refreshingText, status === PullStatus.complete && props.completeText)), /*#__PURE__*/React.createElement("div", {
